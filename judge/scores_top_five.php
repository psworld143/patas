               ...
               <div class="card card-info elevation-2">
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="row">
                        ...
                        <?php
                        $current_judge = $_SESSION['username'];
                        $query = "SELECT * FROM `event_category` WHERE category_name ='Top Five' ORDER BY order_number ASC LIMIT 1";
                        if ($result = $con->query($query)) {
                           $row = $result->fetch_assoc();
                           $category_id = $row['id'];
                           echo '
                           ...
                           <div class="info-box">
                              ...
                              ';
                              $query2 = "SELECT * FROM topfive LEFT JOIN contestants ON contestants.id = topfive.contestant ORDER BY contestant_no ASC";
